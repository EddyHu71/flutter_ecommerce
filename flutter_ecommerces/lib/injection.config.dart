...
import 'application/auth/auth_controller.dart' as _i14;
import 'application/login/login_controller.dart' as _i17;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i14.AuthController>(() =>
      _i14.AuthController(get<_i10.IAuthRepository>(), get<_i5.IStorage>()));
  gh.lazySingleton<_i15.ILoginRepository>(() =>
      _i16.LoginRepository(get<_i12.INetworkService>(), get<_i5.IStorage>()));
  gh.factory<_i17.LoginController>(() =>
      _i17.LoginController(get<_i15.ILoginRepository>(), get<_i5.IStorage>()));
  return get;
}
